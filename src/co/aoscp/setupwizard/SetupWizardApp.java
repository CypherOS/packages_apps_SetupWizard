...
import co.aoscp.setupwizard.util.NetworkMonitor;
import co.aoscp.setupwizard.util.PhoneMonitor;
...
public class SetupWizardApp extends Application {
    ...
    public static final String ACTION_FINISHED = "co.aoscp.setupwizard.SETUP_FINISHED";
