...
package co.aoscp.setupwizard.util;
...
import static co.aoscp.setupwizard.SetupWizardApp.KEY_DETECT_CAPTIVE_PORTAL;
...
import co.aoscp.setupwizard.BluetoothSetupActivity;
import co.aoscp.setupwizard.ChooseDataSimActivity;
import co.aoscp.setupwizard.FingerprintActivity;
import co.aoscp.setupwizard.MobileDataActivity;
import co.aoscp.setupwizard.SetupWizardApp;
import co.aoscp.setupwizard.SimMissingActivity;
import co.aoscp.setupwizard.WifiSetupActivity;
import co.aoscp.setupwizard.wizardmanager.WizardManager;
...
public class SetupWizardUtils {
    ...
    public static void disableComponentsForMissingFeatures(Context context) {
        ...
        if (hasLeanback(context) &&
            !isPackageInstalled(context, GMS_PACKAGE)) {
