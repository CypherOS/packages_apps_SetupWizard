...
package org.aoscp.setupwizard.util;
...
import static org.aoscp.setupwizard.SetupWizardApp.KEY_DETECT_CAPTIVE_PORTAL;
...
import org.aoscp.setupwizard.BluetoothSetupActivity;
import org.aoscp.setupwizard.ChooseDataSimActivity;
import org.aoscp.setupwizard.FingerprintActivity;
import org.aoscp.setupwizard.MobileDataActivity;
import org.aoscp.setupwizard.SetupWizardApp;
import org.aoscp.setupwizard.SimMissingActivity;
import org.aoscp.setupwizard.WifiSetupActivity;
import org.aoscp.setupwizard.wizardmanager.WizardManager;
...
public class SetupWizardUtils {
    ...
    public static boolean isAppInstalled(final Context context, final String packageName) {
        if (uid == -1) {
            PackageManager pm = context.getPackageManager();
            try {
                uid = pm.getPackageUidAsUser(packageName, 0, UserHandle.USER_SYSTEM);
